...
批准文档：[`../docs/SPEC_GENERAL.md`](../../../docs/archive/specs/SPEC_GENERAL.md)、[`../docs/decisions/0009-general-host-config-and-1gib.md`](../../../docs/decisions/0009-general-host-config-and-1gib.md)。
...
- [x] [`../docs/SPEC_GENERAL.md`](../../../docs/archive/specs/SPEC_GENERAL.md) 完成标准满足。
