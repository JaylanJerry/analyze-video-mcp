...
> **历史方向：不再作为下一大版本实施规格。** 新目标见 [`SPEC_NEXT_MAJOR_MEDIA_GATEWAY.md`](../../SPEC_MEDIA_GATEWAY.md) 与 [ADR 0024](../../decisions/0024-agent-directed-media-gateway.md)；下文保留原 v0.7 设想和当时状态。
