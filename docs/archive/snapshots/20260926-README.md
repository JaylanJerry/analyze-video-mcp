...
> **2026-09-25 状态：** 本工作区分支已实现下一大版本单入口媒体网关 `analyze_media(media, prompt)`（本地 MP4/MOV/MP3 + 公开 HTTPS 视频），[`API_CONTRACT.md`](../../API_CONTRACT.md)、[`ARCHITECTURE.md`](../../ARCHITECTURE.md)、[`SECURITY.md`](../../SECURITY.md) 已同步为**本分支实现**；**npm 已发布的 `0.6.1` 仍是旧 `analyze_video` 契约**，安装示例与 `/tasks` 中的历史记录保持旧事实。MP3 真实服务商可用性仍未验证。目标规格见 [`SPEC_NEXT_MAJOR_MEDIA_GATEWAY.md`](../../SPEC_MEDIA_GATEWAY.md) 与 [ADR 0024](../../decisions/0024-agent-directed-media-gateway.md)；实现证据见 [`../tasks/todo-next-major-media-gateway.md`](../../../tasks/archive/1.0/todo-next-major-media-gateway.md)。

| 文档                                                                         | 用途                                                                 |
| ---------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| [`../DEVELOPMENT_HANDOFF.md`](../../../DEVELOPMENT_HANDOFF.md)               | 接手模型入口、接受范围与工作规则                                     |
| [`SPEC.md`](../specs/SPEC.md)                                                | v1 产品范围、约束、完成定义                                          |
| [`SPEC_V2.md`](../specs/SPEC_V2.md)                                          | V2 完整情况规格（草稿，供通读）                                      |
| [`SPEC_GENERAL.md`](../specs/SPEC_GENERAL.md)                                | 通用方向对照表（已批准并实施）                                       |
| [`SPEC_V05.md`](../specs/SPEC_V05.md)                                        | v0.5.0 工程收口（已发布）                                            |
| [`SPEC_V052.md`](../specs/SPEC_V052.md)                                      | v0.5.2 上传缓存、模型 env、安装名                                    |
| [`SPEC_V06.md`](../specs/SPEC_V06.md)                                        | v0.6 宿主稳定、证据门禁、安全默认                                    |
| [`SPEC_V061.md`](../specs/SPEC_V061.md)                                      | v0.6.1 配置同源与审核证据热修                                        |
| [`SPEC_V07.md`](../specs/SPEC_V07.md)                                        | v0.7 纯音频与交叉审核（尚未实施）                                    |
| [`SPEC_NEXT_MAJOR_MEDIA_GATEWAY.md`](../../SPEC_MEDIA_GATEWAY.md)            | 下一大版本单入口媒体网关目标（本分支已实现，未发布）                 |
...
| [`../tasks/plan.md`](../../../tasks/archive/pre-1.0/plan.md)                 | v1 阶段计划                                                          |
| [`../tasks/todo.md`](../../../tasks/archive/pre-1.0/todo.md)                 | v1 任务（已收尾）                                                    |
| [`../tasks/plan-general.md`](../../../tasks/archive/pre-1.0/plan-general.md) | 通用方向实施计划                                                     |
| [`../tasks/todo-general.md`](../../../tasks/archive/pre-1.0/todo-general.md) | 通用方向任务（已收尾）                                               |
| [`../tasks/plan-v05.md`](../../../tasks/archive/pre-1.0/plan-v05.md)         | v0.5.0 实施计划                                                      |
| [`../tasks/todo-v05.md`](../../../tasks/archive/pre-1.0/todo-v05.md)         | v0.5.0 任务                                                          |
